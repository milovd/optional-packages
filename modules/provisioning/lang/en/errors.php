...
return [
    'cannot_provision' => 'This service cannot be provisioned in its current state.',
    'cannot_review' => 'This service cannot be sent to manual review in its current state.',
