...
return [
    'settings' => [
        'api_user' => 'Namecheap API-gebruiker',
        'api_user_help' => 'De API-gebruiker die toegang heeft tot dit Namecheap-account.',
        'api_key' => 'Namecheap API-sleutel',
        'api_key_help' => 'Versleuteld opgeslagen en na opslaan niet opnieuw getoond.',
