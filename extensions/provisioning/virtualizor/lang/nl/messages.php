...
return [
    ...
    'settings' => [
        ...
        'api_secret_help' => 'Configureer de providerverbinding. Geheimen worden versleuteld opgeslagen en nooit opnieuw getoond.',
    ],
    'product' => [
        'plan_id' => 'Plan-id',
        'plan_id_help' => 'Providerkoppeling voor dit product.',
        'location' => 'Locatie',
        'location_help' => 'Providerkoppeling voor dit product.',
    ],
    'actions' => [
        'start' => 'Starten',
        'stop' => 'Stoppen',
