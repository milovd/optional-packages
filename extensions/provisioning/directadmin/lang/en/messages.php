...
return [
    ...
    'settings' => [
        ...
        'api_username_help' => 'Configure the provider connection. Secrets are encrypted at rest and never shown again.',
    ],
    'product' => [
        'domain' => 'Domain',
        'domain_help' => 'Provider mapping used for this product.',
        'package' => 'Package',
        'package_help' => 'Provider mapping used for this product.',
        'username' => 'Account username',
        'username_help' => 'Provider mapping used for this product.',
    ],
    'actions' => [
        'start' => 'Start',
        'stop' => 'Stop',
