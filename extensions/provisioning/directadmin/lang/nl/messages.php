...
return [
    ...
    'settings' => [
        ...
        'api_username_help' => 'Configureer de providerverbinding. Geheimen worden versleuteld opgeslagen en nooit opnieuw getoond.',
    ],
    'product' => [
        'domain' => 'Domein',
        'domain_help' => 'Providerkoppeling voor dit product.',
        'package' => 'Pakket',
        'package_help' => 'Providerkoppeling voor dit product.',
        'username' => 'Accountgebruikersnaam',
        'username_help' => 'Providerkoppeling voor dit product.',
    ],
    'actions' => [
        'start' => 'Starten',
        'stop' => 'Stoppen',
