...
return [
    ...
    'settings' => [
        ...
        'organization_id_help' => 'Configure the provider connection. Secrets are encrypted at rest and never shown again.',
    ],
    'product' => [
        'template_id' => 'Template id',
        'template_id_help' => 'Provider mapping used for this product.',
        'region' => 'Region',
        'region_help' => 'Provider mapping used for this product.',
        'plan' => 'Plan',
        'plan_help' => 'Provider mapping used for this product.',
    ],
    'actions' => [
        'start' => 'Start',
        'stop' => 'Stop',
