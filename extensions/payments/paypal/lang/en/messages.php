...
return [
    ...
    'settings' => [
        ...
        'subscription_plan_id_help' => 'Existing active PayPal Billing Plan ID for automatic subscriptions. The plan price, currency, interval, and trial must match the product.',
    ],
    'health' => [
    ...
    'errors' => [
        ...
        'subscription_failed' => 'The PayPal subscription could not be started.',
        'subscription_plan_missing' => 'PayPal automatic subscriptions require an active subscription plan ID.',
        'subscription_plan_invalid' => 'The configured PayPal subscription plan does not match this product price, currency, interval, or trial.',
        'subscription_cancel_failed' => 'The PayPal subscription could not be cancelled.',
        'subscription_resume_failed' => 'The PayPal subscription could not be resumed.',
